...
export const animationList: ICard2[] = [
  ...
  },
  {
    ...
    desc: '非常强大的粒子动画库',
    img: '/images/plugins/tsParticles.png',
    imgStyle: { width: '150px' },
