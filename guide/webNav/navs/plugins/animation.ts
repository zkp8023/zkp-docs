...
export const animationList: ICard2[] = [
...

  {
    name: 'animejs',
    desc: '好用的动画库,演示效果很清楚',
    img: '/assets/images/plugins/anime.svg',
  ...
  },
  {
    ...
    img: '/assets/images/plugins/proton.svg',
    imgStyle: { width: '150px' },
  ...
  },
  {
    ...
    desc: '非常强大的粒子动画库',
    img: '/assets/images/plugins/tsParticles.png',
    imgStyle: { width: '150px' },
  ...
  },
  {
    ...
    img: '/assets/images/plugins/svgJs.png',
...
export const cssAnimationList: ICard2[] = [
  {
    ...
    img: '/assets/images/plugins/animate-css.png',
    src: 'https://animate.style/',
  },
  {
    name: 'animista css的各种动画',
    desc: '动画调试 , 动画效果 , text动画',
    img: '/assets/images/plugins/animista.svg',
