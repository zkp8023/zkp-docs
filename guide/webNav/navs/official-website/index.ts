...
export const vueList: ICard2[] = [
  ...
  {
    name: 'Nuxt',
    img: '/docs/images/official/nuxt.svg',
  ...
  {
    name: 'VueUse',
    img: '/docs/images/official/vueuse.svg',
  ...
  {
    name: 'Pinia',
    img: '/docs/images/official/pinia.svg',
    src: 'https://pinia.vuejs.org/zh/getting-started.html',
  },
  {
    name: 'Vue Macros',
    img: '/docs/images/official/macros-vue.svg',
  ...
  {
    name: 'Vue-Request',
    img: '/docs/images/official/vue-request.png',
    src: 'https://www.attojs.com/guide/introduction.html',
  },
  {
    name: 'Vue-i18n',
    img: '/docs/images/official/vue-i18n.svg',
    src: 'https://vue-i18n.intlify.dev/',
  },

  {
    name: 'uniapp',
    img: '/docs/images/official/uni-app.svg',
    src: 'https://zh.uniapp.dcloud.io',
  },
  {
    name: 'Tresjs',
    img: '/docs/images/official/tres.svg',
...
export const reactList: ICard2[] = [
  {
    name: 'React',
    img: '/docs/images/official/React.svg',
  ...
  {
    name: 'SWR',
    img: '/docs/images/official/swr.svg',
    imgStyle: { width: '75px' },
  ...
  {
    name: 'ahooks',
    img: '/docs/images/official/ahooks.svg',
    imgStyle: { width: '90px' },
  ...
  {
    name: 'React Redux',
    img: '/docs/images/official/Redux.svg',
  ...
  {
    name: 'Recoil',
    img: '/docs/images/official/Recoil.svg',
    imgStyle: { width: '90px' },
  ...
  {
    name: 'mobx',
    img: '/docs/images/official/mobx.png',
  ...
  },
  {
    ...
    img: '/docs/images/official/React-Navigation.svg',
...
export const electronList: ICard2[] = [
  {
    name: 'Electron',
    img: '/docs/images/official/electron.svg',
  ...
  },
  {
    ...
    img: '/docs/images/official/electron-vite-vue.svg',
  ...
  {
    name: 'electron-vite',
    img: '/docs/images/official/electron-vite.svg',
...
export const cssList: ICard2[] = [
  {
    name: 'Sass',
    img: '/docs/images/official/sass.svg',
  ...
  {
    name: 'Less',
    img: '/docs/images/official/less.png',
  ...
  {
    name: 'UnoCss',
    img: '/docs/images/official/unocss.svg',
  ...
  {
    name: 'Tailwind CSS',
    img: '/docs/images/official/tailwindcss.svg',
  ...
  {
    name: 'Windi CSS',
    img: '/docs/images/official/windicss.svg',
  ...
  {
    name: 'Bootstrap',
    img: '/docs/images/official/Bootstrap.svg',
  ...
  },
  {
    ...
    img: '/docs/images/official/styledcomponents.svg',
  ...
  {
    name: 'styleX',
    img: '/docs/images/official/styleX.svg',
...
export const iconList: ICard2[] = [
  {
    name: 'Iconfont',
    img: '/docs/images/official/iconfont.svg',
  ...
  {
    name: 'Yesicon',
    img: '/docs/images/official/yesicon.svg',
    src: 'https://yesicon.app/',
    desc: '20万+图标',
  },
  {
    name: 'iconify',
    img: '/docs/images/official/iconify.svg',
  ...
  {
    name: 'IconPark',
    img: '/docs/images/official/iconpark.svg',
...

  {
    name: 'Emoji 表情大全',
    desc: '很全的Emoji',
    img: '/docs/images/tools/emoji.svg',
    src: 'https://www.emojiall.com/zh-hans',
  },
  {
    name: 'SearchEmoji',
    desc: '好多Emoji',
    img: '/docs/images/official/searchEmoji.png',
...
export const libraryList: ICard2[] = [
  {
    name: 'TypeScript',
    img: '/docs/images/official/typeScript.svg',
    enSrc: 'https://www.typescriptlang.org/',
    zhSrc: 'https://ts.nodejs.cn/',
  },
  {
    name: 'axios',
    img: '/docs/images/official/axios.svg',
  ...
  {
    name: 'Lodash',
    img: '/docs/images/official/lodash.png',
    src: 'https://www.lodashjs.com/',
  },
  {
    name: 'Day.js',
    img: '/docs/images/official/dayjs.svg',
  ...
  {
    name: 'Unplugin',
    img: '/docs/images/official/unplugins.svg',
    src: 'https://unplugin.unjs.io/guide/',
    tooltip: '为各种构建工具提供统一插件系统的库',
  },
  {
    name: 'Mock.js',
    img: '/docs/images/official/mockjs.svg',
...
export const harmonyList: ICard2[] = [
  {
    name: 'OpenHarmony',
    img: '/docs/images/official/openHarmony.png',
    imgStyle: { width: '130px', height: '40px' },
    src: 'https://docs.openharmony.cn/',
  },
  {
    name: 'HarmonyOS',
    img: '/docs/images/official/harmony-os.svg',
